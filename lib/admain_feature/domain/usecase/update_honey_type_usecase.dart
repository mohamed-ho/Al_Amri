...
class UpdateHoneyTypeUsecase extends Usecase<Map<String, dynamic>, HoneyType> {
  final HoneyTypeRepository honeyTypeRepository;

  UpdateHoneyTypeUsecase({required this.honeyTypeRepository});
  @override
  Future<Either<Failure, Map<String, dynamic>>> call(HoneyType params) async =>
      await honeyTypeRepository.updateType(params);
}
