...
import 'package:alamri_adm/features/item_feature/data/repository/items_repository_impl.dart';
...
class ItemsInjection {
  void init() {
    ...
    ls.registerLazySingleton<ItemRemoteDataSource>(
        () => ItemRemoteDataSourceImpl(dioConsumer: ls(), httpConsumer: ls()));
    ls.registerLazySingleton(() => HttpConsumer());
  }
}
