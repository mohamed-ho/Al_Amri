...
import 'package:alamri_adm/features/offer_feature/data/repository/offer_repository_impl.dart';
import 'package:alamri_adm/features/offer_feature/data/soutce_data/offer_remote_data_source.dart';
import 'package:alamri_adm/features/offer_feature/domain/repository/offer_repository.dart';
import 'package:alamri_adm/features/offer_feature/domain/usecase/add_offer_usercase.dart';
import 'package:alamri_adm/features/offer_feature/domain/usecase/delete_offer_usecase.dart';
import 'package:alamri_adm/features/offer_feature/domain/usecase/get_List_of_offers_usecase.dart';
import 'package:alamri_adm/features/offer_feature/domain/usecase/get_offfer_usecase.dart';
import 'package:alamri_adm/features/offer_feature/domain/usecase/update_offer_usecase.dart';
...
class OfferInjection {
  void init() {
    ...
    ls.registerLazySingleton<OfferRemoteDataSource>(
        () => OfferRemoteDataSourceImpl(dioConsumer: ls(), httpConsumer: ls()));
  }
}
