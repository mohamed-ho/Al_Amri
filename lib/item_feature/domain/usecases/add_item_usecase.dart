...
class AddItemUsecase implements Usecase<Map<String, dynamic>, Item> {
  final ItemsRepository itemsRepository;

  AddItemUsecase({required this.itemsRepository});
  @override
  Future<Either<Failure, Map<String, dynamic>>> call(Item params) async {
    return await itemsRepository.addItem(params);
  }
}
